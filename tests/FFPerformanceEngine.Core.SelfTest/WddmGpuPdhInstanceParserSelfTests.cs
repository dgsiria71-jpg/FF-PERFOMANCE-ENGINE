...
internal static class WddmGpuPdhInstanceParserSelfTests
{
    ...
    private static void RunCore()
    {
        ...
        _stage = "process-and-engine-type-do-not-change-physical-key";
        Require(WddmGpuPdhInstanceParser.TryParsePhysicalEngineKey(
